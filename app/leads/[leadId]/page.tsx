...
export default function LeadDetailPage() {
  ...
  const [activeTab, setActiveTab] = useState<"customer" | "vehicle" | "valuation" | "internal">("customer");
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="h-24 w-24 bg-gradient-to-br from-red-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-xl">
            <FileText className="h-12 w-12 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Lead not found</h1>
          <p className="text-gray-600 mb-6">The lead you're looking for doesn't exist.</p>
          <Button size="lg" onClick={() => router.push("/leads")}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <button
            ...
            className="flex items-center text-gray-600 hover:text-gray-900 mb-6 group font-medium"
          >
          ...
          <div className="glass-effect rounded-2xl shadow-soft border border-white/20 p-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="flex items-center space-x-6 mb-6 lg:mb-0">
                <div className="h-20 w-20 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-2xl flex items-center justify-center shadow-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* Tabs */}
            <div className="glass-effect rounded-2xl shadow-soft border border-white/20 overflow-hidden">
              ...
              <div className="p-8">
                {activeTab === "customer" && <CustomerSection lead={lead} />}
...
const TabButton = ({
  ...
  <button
    onClick={onClick}
    className={`flex items-center px-6 py-4 font-semibold text-sm transition-all relative ${
      active
        ? "text-primary-600"
  ...
  >
    ...
    {children}
    {active && (
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-t-full"></div>
    )}
  </button>
);
...
const CustomerSection = ({ lead }: { lead: Lead }) => (
  <div className="space-y-6">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <InfoCard icon={User} label="Customer Name" value={lead.customer.name} />
  ...
  <div className="space-y-6">
    ...
    {lead.valuation.notes && (
      <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-100">
        ...
        <p className="text-sm text-gray-700 leading-relaxed">{lead.valuation.notes}</p>
      </div>
    )}
  </div>
);
      ...
      <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100">
        ...
        <div className="flex flex-wrap gap-3">
          {lead.internal.followUpDates.map((date, index) => (
            <div
              key={index}
              className="flex items-center bg-white px-4 py-2 rounded-lg shadow-sm border border-purple-200"
            >
    ...
    {badge ? (
      ...
      <p
        className={`text-sm mt-1 ${
          highlight
            ? "text-2xl font-bold bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent"
...
const ContactItem = ({
  ...
  <div className="flex items-start space-x-3">
    <div className={`h-10 w-10 bg-gradient-to-br ${gradient} rounded-xl flex items-center justify-center shadow-md flex-shrink-0`}>
...
const TimelineItem = ({
  ...
  <div className="flex items-start space-x-3">
    <div className={`h-10 w-10 bg-gradient-to-br ${color} rounded-xl flex items-center justify-center shadow-md flex-shrink-0`}>
      <Icon className="h-5 w-5 text-white" />
    </div>
    <div>
